...
function createMemoryBrand() {
  ...
  brand.innerHTML = '<img class="memory-brand-mark" src="/icon.svg?v=20260607-soft-magic" alt=""><span>phd</span>';
...
function createTopbar() {
  ...
  brand.href = "/";
  brand.setAttribute("aria-label", "phd home");
  brand.innerHTML = '<img class="suite-app-mark" src="/icon.svg?v=20260607-soft-magic" alt=""><span class="suite-app-name">phd</span>';
  const home = el("a", "suite-ao-home");
  home.href = "https://aolabs.io/";
  home.setAttribute("aria-label", "aolabs.io");
  home.innerHTML = '<img src="https://aolabs.io/marks/ao-ink.svg?v=20260516-suite-bloom" alt="">';
